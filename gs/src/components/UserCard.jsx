...
function UserCard({ user, onCardClick }) {
  return (
    <div 
      ...
      // 1. h-full: Faz o card ocupar 100% da altura da célula do grid
      // 2. flex flex-col: Organiza o conteúdo internamente em coluna
    ...
    >
      ...
      {/* 3. flex-grow "empurra" as skills para o final do card */}
